...
function EditPostPage({params}) {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            if(!res.ok){
                throw new Error("Falied to update post")
            }
  ...
  return (
    <div className='container mx-auto py-10'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <textarea onChange={(e) => setNewContent(e.target.value)} className='w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2' placeholder={postData.content}></textarea>
